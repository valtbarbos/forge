...
export class WindowManager extends GObject.Object {
        ...
        if (!metaWindow.windowSignals) {
          let windowSignals = [
            ...
            metaWindow.connect("focus", (_metaWindowFocus) => {
              // Skip focus handling during window destruction
        ...
        this.queueEvent(
          {
            ...
            callback: () => {
              ...
              // Move pointer after window geometry is finalized
              this.movePointerWith(nodeWindow, { force: true });
            },
          },
          200
        );
  ...
  windowDestroy(actor) {
    // Set flag to prevent mouse movement during window destruction
